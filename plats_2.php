                ...
                <?php
                    ...
                    echo '<div class="col-lg-3 mb-5 mb-lg-5 mt-3 mt-lg-5 ms-lg-2 me-lg-2">';
                        echo '<div class="card w-auto border-4 bordures rounded-5">';
                            ...
                            echo '<a href="test_commande.php?id=' . $plat['id'] . '" class="card-text fs-5 fw-medium text-center shadow-lg p-2 m-3 mt-0 rounded-4 text-decoration-none fond_logo lettres_blanches">' . "Commander" . '</a>';
                        echo '</div>';
                    echo '</div>';
                    }
